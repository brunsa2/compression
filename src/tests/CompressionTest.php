...
class CompressionTest extends PHPUnit_Framework_TestCase {
	public function testCompression() {
		...
		$compressionStream->write('The quick brown fox jumps over a lazy dog.');
		...
		$this->assertEquals('The quick brown fox jumps over a lazy dog.', (string) $decompressionStream->getStream());
		
		if(strlen((string) $compressionStream) > strlen('The quick brown fox jumps over a lazy dog.')) {
